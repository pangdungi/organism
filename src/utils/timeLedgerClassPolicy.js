...
export const LP_MAIN_CLASS = new Set([
  ...
  "app-home-menu-launcher-account-btn",
  "app-home-menu-launcher-account-icon-wrap",
  ...
  "app-home-menu-launcher-logo",
  "app-home-menu-launcher-logo-float-shell",
  "app-home-menu-launcher-placeholder",
  "app-home-menu-launcher-section-list",
  "app-home-menu-launcher-section-grid",
  "app-home-menu-launcher-title",
  "app-home-menu-launcher-topbar",
  "app-main",
  "app-page",
  "app-tab-panel",
  ...
  "dream-view-label",
  "dream-view-title",
  "habit-tracker-content-wrap",
  "habit-tracker-page-grid-cell--before-start",
  "habit-tracker-page-grid-cell--lv1",
  "habit-tracker-page-grid-cell--lv2",
  "habit-tracker-page-grid-cell--lv3",
  "habit-tracker-page-grid-cell--lv4",
  "habit-tracker-page-grid-cell--ok",
  "habit-tracker-page-grid-cell--value",
  "habit-tracker-page-grid-month-nav",
  "habit-tracker-page-grid-month-nav-btn",
  "habit-tracker-page-grid-month-nav-label",
  "habit-tracker-page-grid-scroll",
  "habit-tracker-page-grid-table",
  "habit-tracker-page-grid-td",
  "habit-tracker-page-grid-td--cell",
  "habit-tracker-page-grid-td--habit",
  "habit-tracker-page-grid-td--today",
  "habit-tracker-page-grid-wrap",
  "idea-app-font-dropdown-slot",
  "idea-basic-row",
  "idea-basic-rows",
  "idea-btn-calc",
  "idea-btn-change-password",
  "idea-btn-save-hourly-direct",
  ...
  "idea-hourly-form",
  "idea-hourly-panel",
  "idea-hourly-panel--calc",
  "idea-hourly-panel--direct",

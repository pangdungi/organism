...
export const LP_MAIN_CLASS = new Set([
  ...
  "habit-tracker-page-grid-th",
  "habit-tracker-page-grid-th--day",
  "habit-tracker-page-grid-th--habit",
  "habit-tracker-page-grid-th--today",
  "habit-tracker-page-grid-th--year",

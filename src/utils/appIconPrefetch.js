...
const CRITICAL_HOME_ICON_PATHS = [
  ...
  "/toolbaricons/time-task/prod-cat-dream-new.svg",
  "/toolbaricons/time-task/prod-cat-sideincome-new.svg",
  "/toolbaricons/time-task/prod-cat-health-new.svg",
  "/toolbaricons/time-task/prod-cat-happiness-new.svg",

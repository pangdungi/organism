-- ui_font_id: 온글잎 류류체 제거 (가독성 이슈)

update public.user_subscriptions
set ui_font_id = 'cocochoitoon'
where ui_font_id = 'ryuryu';

comment on column public.user_subscriptions.ui_font_id is
  '앱 UI 글꼴 id; cocochoitoon | gongbujahana | mongtori | cherryspoon | myeoneunheulrim (+ legacy ids)';
